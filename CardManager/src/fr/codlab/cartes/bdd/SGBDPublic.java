...
public class SGBDPublic {
    ...
    //---opens the database---
    public SGBDPublic open() throws SQLException {
    ...
    private Cursor getPossessions(Language lang) {
        ...
        switch (lang) {
            case FR:
                table = TABLE_POSSESSIONS_FR;
                break;
            case DE:

                table = TABLE_POSSESSIONS_DE;
                break;
            case ES:

                table = TABLE_POSSESSIONS_ES;
                break;
            case IT:

                table = TABLE_POSSESSIONS_IT;
                break;
            default:

                table = TABLE_POSSESSIONS;
        }
        cursor = db.query(true, table, new String[]{
                "extension as e",
                "carte as c",
                "quantite as q",
                "quantite_holo as qh",
    ...
    private String getEncodedPossessionsSubLanguage(Language lang) {
        ...
        switch (lang) {
            case FR:
                json_envoi += "],nb_fr:'" + nb_cartes + "'";
                break;
            case DE:
                json_envoi += "],nb_de:'" + nb_cartes + "'";
                break;
            case ES:
                json_envoi += "],nb_es:'" + nb_cartes + "'";
                break;
            case IT:
                json_envoi += "],nb_it:'" + nb_cartes + "'";
                break;
            default:
